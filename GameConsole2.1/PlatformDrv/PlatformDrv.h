...
//Возвращает сигнал клавиатуры
//Если сигналов нет - ставит вызвавший процесс на ожидание до прихода сигнала на указанный интервал.
//Если данные пришли до истечения указанного интервала, в remain будет остаток времени
